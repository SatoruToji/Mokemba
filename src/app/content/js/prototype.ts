export const prototypes: Record<string, string>[] = [
    ...
    {
        '/MokembaMascot/js/prototype/8.png': 'И такое исследование предков будет продолжаться пока цепочка не кончится на undefined. По цепочке. Но если движок ничего не найдет даже у объектов конструкторов, то тебе вернется "undefined"'
    },
    {
